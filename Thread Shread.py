...
for one in daily_transactions:
  daily_transactions_split.append(one.split(";"))
...
# How much thread of any specific color
thread_sold_split = []
...
# Do not understand the below code: How is the function color_count able to call color. I do not see how it gets the indicies from colors list
for color in colors:
